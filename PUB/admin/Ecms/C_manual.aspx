<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="C_manual.aspx.vb" Inherits="Cms1.C_manual" %>
...
<body>
    <form id="form1" runat="server"><h3>各种资料分类</h3>
    <TableList:Tlistdata  id="tadata"  class="logins" 
        DBOrd="6" DBname="Category_Manuals" TjExpression=""
        runat="server">
    </TableList:Tlistdata>
    </form>
</body>
