<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Csbitem.aspx.vb" Inherits="Cms1.Csbitem" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>承试报价单细项编辑</title>
    ...
    <div>
        <table><tr>
            ...
            <tr>
                <td>人员名称</td>
                <td>
                    <asp:TextBox ID="Txtrymc" runat="server" Width="210px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style5">设备名称</td>
                <td class="auto-style6">
                    <asp:TextBox ID="Txtsbmc" runat="server" Width="208px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style5">配件名称</td>
                <td class="auto-style6">
                    <asp:TextBox ID="Txtpjmc" runat="server" Width="208px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style5">其他</td>
                <td class="auto-style6">
                    <asp:TextBox ID="Txtqt" runat="server" Width="208px"></asp:TextBox>
                </td>
            </tr>
            <tr>
